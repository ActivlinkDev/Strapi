 ...
 * validate-customer) — 545 fields in 8 languages.
 *
 ...
 * {products}, {n}, {device}, {months}, {amount}, {percent}, {size}, {price},
 * {name}, {oneOff} and {monthly} are substituted by the frontend and are kept
 * byte-identical across every language — do not translate or reorder them.
 *
 * The one exception is {plural}, which the frontend fills with the English
 * plural "s". Only the English strings use it; every other language phrases the
 * sentence so it works for one item or many, and an omitted placeholder is left
 * unsubstituted rather than inserting stray English.
 *
...
const CONTENT = {
  "basket": {
    "en": {
      ...
      "Step_device": "Your device",
      "Step_cover": "Choose cover",
      "Step_basket": "Basket",
      "Step_payment": "Secure payment",
      "Checkout_progress": "Checkout progress",
      "Order_summary": "Order summary",
      "Reassurance_title": "Good to know",
      "Secure_payment": "Payment is handled securely by Stripe — we never see your card details.",
      "Documents_emailed": "A contract is issued for every item as soon as your payment is confirmed, and you can view it any time under My contracts.",
      "Term_monthly": "Monthly cover, until cancelled",
      "Term_months": "{months} months cover",
      "Monthly_equivalent": "about {amount} a month",
      "Per_month_suffix": "/month",
      "Billing_monthly": "Monthly",
      "Billing_one_off": "One-off",
      "Payment_monthly": "Billed monthly until you cancel.",
      "Payment_once": "One-off payment — nothing recurring.",
      "Payment_mixed": "This basket mixes one-off and monthly cover.",
      "Payment_mixed_warning": "Your basket holds {oneOff} one-off and {monthly} monthly plan(s). These cannot be paid for in one transaction — remove one kind to continue, then check the other out separately.",
      "Promotion": "Promotion",
      "Discount": "Discount",
      "You_save": "You save {amount}",
      "Save_more_percent": "Add {count} more item{plural} to your basket and save {percent}%.",
      "Save_more_bundle": "Add {count} more item{plural} for a {size}-item bundle at {price}.",
      "Covers_label": "Covers",
      "Whats_covered": "What's covered",
      "Hide_covered": "Hide what's covered",
      "Exclusions": "What's not covered",
      "Hide_exclusions": "Hide what's not covered",
      "Terms_link": "Policy terms",
      "Change_cover": "Change cover",
      "Plan_ref": "Plan",
      "Confirm_remove": "Yes, remove",
      "Cancel": "Keep",
      "Removed_notice": "{name} was removed from your basket.",
      "Add_cover_again": "Add cover again",
      "Dismiss": "Dismiss",
      "Empty_basket_body": "Add a product to see the protection plans available for it, then come back here to check out.",
      "Basket_reference": "Basket reference",
      "Need_help": "Need help with your order?",
      "No_cover_body": "These devices are not covered and are not part of your total. You can still add cover for them now.",
      "No_basket_id": "We could not find a basket to show. Open this page from your offer, or add ?id=YOUR_BASKET_ID to the address."
    },
    "es": {
      ...
      "Step_device": "Tu dispositivo",
      "Step_cover": "Elegir cobertura",
      "Step_basket": "Cesta",
      "Step_payment": "Pago seguro",
      "Checkout_progress": "Progreso del pago",
      "Order_summary": "Resumen del pedido",
      "Reassurance_title": "Información útil",
      "Secure_payment": "El pago lo gestiona Stripe de forma segura: nunca vemos los datos de tu tarjeta.",
      "Documents_emailed": "Se emite un contrato para cada artículo en cuanto se confirma el pago, y puedes consultarlo cuando quieras en Mis contratos.",
      "Term_monthly": "Cobertura mensual, hasta que la canceles",
      "Term_months": "{months} meses de cobertura",
      "Monthly_equivalent": "unos {amount} al mes",
      "Per_month_suffix": "/mes",
      "Billing_monthly": "Mensual",
      "Billing_one_off": "Pago único",
      "Payment_monthly": "Se factura cada mes hasta que canceles.",
      "Payment_once": "Pago único: no hay cargos recurrentes.",
      "Payment_mixed": "Esta cesta mezcla cobertura de pago único y mensual.",
      "Payment_mixed_warning": "Tu cesta tiene {oneOff} plan(es) de pago único y {monthly} plan(es) mensual(es). No se pueden pagar en una sola transacción: quita uno de los dos tipos para continuar y paga el otro por separado.",
      "Promotion": "Promoción",
      "Discount": "Descuento",
      "You_save": "Ahorras {amount}",
      "Save_more_percent": "Añade {count} artículo(s) más a tu cesta y ahorra un {percent}%.",
      "Save_more_bundle": "Añade {count} artículo(s) más para un pack de {size} artículos por {price}.",
      "Covers_label": "Cubre",
      "Whats_covered": "Qué está cubierto",
      "Hide_covered": "Ocultar qué está cubierto",
      "Exclusions": "Qué no está cubierto",
      "Hide_exclusions": "Ocultar qué no está cubierto",
      "Terms_link": "Condiciones de la póliza",
      "Change_cover": "Cambiar cobertura",
      "Plan_ref": "Plan",
      "Confirm_remove": "Sí, quitar",
      "Cancel": "Conservar",
      "Removed_notice": "{name} se ha quitado de tu cesta.",
      "Add_cover_again": "Volver a añadir cobertura",
      "Dismiss": "Descartar",
      "Empty_basket_body": "Añade un producto para ver los planes de protección disponibles y vuelve aquí para finalizar la compra.",
      "Basket_reference": "Referencia de la cesta",
      "Need_help": "¿Necesitas ayuda con tu pedido?",
      "No_cover_body": "Estos dispositivos no tienen cobertura y no forman parte de tu total. Todavía puedes añadirles cobertura ahora.",
      "No_basket_id": "No hemos encontrado ninguna cesta que mostrar. Abre esta página desde tu oferta o añade ?id=TU_ID_DE_CESTA a la dirección."
    },
    "it": {
      ...
      "Step_device": "Il tuo dispositivo",
      "Step_cover": "Scegli la copertura",
      "Step_basket": "Carrello",
      "Step_payment": "Pagamento sicuro",
      "Checkout_progress": "Avanzamento del pagamento",
      "Order_summary": "Riepilogo dell'ordine",
      "Reassurance_title": "Buono a sapersi",
      "Secure_payment": "Il pagamento è gestito in modo sicuro da Stripe: non vediamo mai i dati della tua carta.",
      "Documents_emailed": "Per ogni articolo viene emesso un contratto non appena il pagamento è confermato e puoi consultarlo in qualsiasi momento in I miei contratti.",
      "Term_monthly": "Copertura mensile, fino alla disdetta",
      "Term_months": "{months} mesi di copertura",
      "Monthly_equivalent": "circa {amount} al mese",
      "Per_month_suffix": "/mese",
      "Billing_monthly": "Mensile",
      "Billing_one_off": "Pagamento unico",
      "Payment_monthly": "Addebito mensile fino alla disdetta.",
      "Payment_once": "Pagamento unico: nessun addebito ricorrente.",
      "Payment_mixed": "Questo carrello contiene sia coperture con pagamento unico sia coperture mensili.",
      "Payment_mixed_warning": "Il tuo carrello contiene {oneOff} piano/i con pagamento unico e {monthly} piano/i mensile/i. Non possono essere pagati in un'unica transazione: rimuovi uno dei due tipi per continuare e paga l'altro separatamente.",
      "Promotion": "Promozione",
      "Discount": "Sconto",
      "You_save": "Risparmi {amount}",
      "Save_more_percent": "Aggiungi altri {count} articolo/i al carrello e risparmia il {percent}%.",
      "Save_more_bundle": "Aggiungi altri {count} articolo/i per un pacchetto da {size} articoli a {price}.",
      "Covers_label": "Copre",
      "Whats_covered": "Cosa è coperto",
      "Hide_covered": "Nascondi cosa è coperto",
      "Exclusions": "Cosa non è coperto",
      "Hide_exclusions": "Nascondi cosa non è coperto",
      "Terms_link": "Condizioni della polizza",
      "Change_cover": "Cambia copertura",
      "Plan_ref": "Piano",
      "Confirm_remove": "Sì, rimuovi",
      "Cancel": "Mantieni",
      "Removed_notice": "{name} è stato rimosso dal carrello.",
      "Add_cover_again": "Aggiungi di nuovo la copertura",
      "Dismiss": "Chiudi",
      "Empty_basket_body": "Aggiungi un prodotto per vedere i piani di protezione disponibili, poi torna qui per completare l'acquisto.",
      "Basket_reference": "Riferimento del carrello",
      "Need_help": "Ti serve aiuto con il tuo ordine?",
      "No_cover_body": "Questi dispositivi non sono coperti e non rientrano nel totale. Puoi comunque aggiungere una copertura adesso.",
      "No_basket_id": "Non abbiamo trovato nessun carrello da mostrare. Apri questa pagina dalla tua offerta oppure aggiungi ?id=IL_TUO_ID_CARRELLO all'indirizzo."
    },
    "fr": {
      ...
      "Step_device": "Votre appareil",
      "Step_cover": "Choisir la couverture",
      "Step_basket": "Panier",
      "Step_payment": "Paiement sécurisé",
      "Checkout_progress": "Progression du paiement",
      "Order_summary": "Récapitulatif de la commande",
      "Reassurance_title": "Bon à savoir",
      "Secure_payment": "Le paiement est géré en toute sécurité par Stripe : nous ne voyons jamais les données de votre carte.",
      "Documents_emailed": "Un contrat est émis pour chaque article dès la confirmation de votre paiement, et vous pouvez le consulter à tout moment dans Mes contrats.",
      "Term_monthly": "Couverture mensuelle, jusqu'à résiliation",
      "Term_months": "{months} mois de couverture",
      "Monthly_equivalent": "environ {amount} par mois",
      "Per_month_suffix": "/mois",
      "Billing_monthly": "Mensuel",
      "Billing_one_off": "Paiement unique",
      "Payment_monthly": "Facturé chaque mois jusqu'à votre résiliation.",
      "Payment_once": "Paiement unique : rien de récurrent.",
      "Payment_mixed": "Ce panier mélange des couvertures en paiement unique et des couvertures mensuelles.",
      "Payment_mixed_warning": "Votre panier contient {oneOff} formule(s) en paiement unique et {monthly} formule(s) mensuelle(s). Elles ne peuvent pas être réglées en une seule transaction : retirez l'un des deux types pour continuer, puis payez l'autre séparément.",
      "Promotion": "Promotion",
      "Discount": "Remise",
      "You_save": "Vous économisez {amount}",
      "Save_more_percent": "Ajoutez {count} article(s) de plus à votre panier et économisez {percent} %.",
      "Save_more_bundle": "Ajoutez {count} article(s) de plus pour un lot de {size} articles à {price}.",
      "Covers_label": "Couvre",
      "Whats_covered": "Ce qui est couvert",
      "Hide_covered": "Masquer ce qui est couvert",
      "Exclusions": "Ce qui n'est pas couvert",
      "Hide_exclusions": "Masquer ce qui n'est pas couvert",
      "Terms_link": "Conditions du contrat",
      "Change_cover": "Changer de couverture",
      "Plan_ref": "Formule",
      "Confirm_remove": "Oui, retirer",
      "Cancel": "Conserver",
      "Removed_notice": "{name} a été retiré de votre panier.",
      "Add_cover_again": "Ajouter à nouveau la couverture",
      "Dismiss": "Fermer",
      "Empty_basket_body": "Ajoutez un produit pour voir les formules de protection disponibles, puis revenez ici pour finaliser votre commande.",
      "Basket_reference": "Référence du panier",
      "Need_help": "Besoin d'aide avec votre commande ?",
      "No_cover_body": "Ces appareils ne sont pas couverts et ne font pas partie de votre total. Vous pouvez encore leur ajouter une couverture maintenant.",
      "No_basket_id": "Nous n'avons trouvé aucun panier à afficher. Ouvrez cette page depuis votre offre ou ajoutez ?id=VOTRE_ID_DE_PANIER à l'adresse."
    },
    "de": {
      ...
      "Step_device": "Ihr Gerät",
      "Step_cover": "Schutz wählen",
      "Step_basket": "Warenkorb",
      "Step_payment": "Sichere Zahlung",
      "Checkout_progress": "Fortschritt der Bestellung",
      "Order_summary": "Bestellübersicht",
      "Reassurance_title": "Gut zu wissen",
      "Secure_payment": "Die Zahlung wird sicher über Stripe abgewickelt – wir sehen Ihre Kartendaten nie.",
      "Documents_emailed": "Für jeden Artikel wird ein Vertrag ausgestellt, sobald Ihre Zahlung bestätigt ist. Sie können ihn jederzeit unter Meine Verträge einsehen.",
      "Term_monthly": "Monatlicher Schutz, bis zur Kündigung",
      "Term_months": "{months} Monate Schutz",
      "Monthly_equivalent": "etwa {amount} pro Monat",
      "Per_month_suffix": "/Monat",
      "Billing_monthly": "Monatlich",
      "Billing_one_off": "Einmalig",
      "Payment_monthly": "Monatliche Abrechnung bis zur Kündigung.",
      "Payment_once": "Einmalige Zahlung – nichts Wiederkehrendes.",
      "Payment_mixed": "Dieser Warenkorb enthält sowohl einmaligen als auch monatlichen Schutz.",
      "Payment_mixed_warning": "Ihr Warenkorb enthält {oneOff} Tarif(e) mit Einmalzahlung und {monthly} monatliche(n) Tarif(e). Beides lässt sich nicht in einer Transaktion bezahlen – entfernen Sie eine der beiden Arten, um fortzufahren, und bezahlen Sie die andere separat.",
      "Promotion": "Aktion",
      "Discount": "Rabatt",
      "You_save": "Sie sparen {amount}",
      "Save_more_percent": "Legen Sie {count} weitere Artikel in den Warenkorb und sparen Sie {percent} %.",
      "Save_more_bundle": "Legen Sie {count} weitere Artikel dazu für ein Paket mit {size} Artikeln zu {price}.",
      "Covers_label": "Schützt",
      "Whats_covered": "Was abgedeckt ist",
      "Hide_covered": "Abgedeckte Leistungen ausblenden",
      "Exclusions": "Was nicht abgedeckt ist",
      "Hide_exclusions": "Nicht abgedeckte Leistungen ausblenden",
      "Terms_link": "Vertragsbedingungen",
      "Change_cover": "Schutz ändern",
      "Plan_ref": "Tarif",
      "Confirm_remove": "Ja, entfernen",
      "Cancel": "Behalten",
      "Removed_notice": "{name} wurde aus Ihrem Warenkorb entfernt.",
      "Add_cover_again": "Schutz erneut hinzufügen",
      "Dismiss": "Schließen",
      "Empty_basket_body": "Fügen Sie ein Produkt hinzu, um die verfügbaren Schutzpakete zu sehen, und kommen Sie dann hierher zurück, um zu bezahlen.",
      "Basket_reference": "Warenkorb-Referenz",
      "Need_help": "Brauchen Sie Hilfe bei Ihrer Bestellung?",
      "No_cover_body": "Diese Geräte sind nicht abgesichert und zählen nicht zu Ihrer Summe. Sie können jetzt noch Schutz dafür hinzufügen.",
      "No_basket_id": "Wir konnten keinen Warenkorb finden. Öffnen Sie diese Seite über Ihr Angebot oder hängen Sie ?id=IHRE_WARENKORB_ID an die Adresse an."
    },
    "nl": {
      ...
      "Step_device": "Je apparaat",
      "Step_cover": "Dekking kiezen",
      "Step_basket": "Winkelmandje",
      "Step_payment": "Veilig betalen",
      "Checkout_progress": "Voortgang van de bestelling",
      "Order_summary": "Overzicht van je bestelling",
      "Reassurance_title": "Goed om te weten",
      "Secure_payment": "De betaling verloopt veilig via Stripe – wij zien je kaartgegevens nooit.",
      "Documents_emailed": "Voor elk artikel wordt een contract opgesteld zodra je betaling is bevestigd, en je kunt het altijd bekijken onder Mijn contracten.",
      "Term_monthly": "Maandelijkse dekking, tot je opzegt",
      "Term_months": "{months} maanden dekking",
      "Monthly_equivalent": "ongeveer {amount} per maand",
      "Per_month_suffix": "/maand",
      "Billing_monthly": "Maandelijks",
      "Billing_one_off": "Eenmalig",
      "Payment_monthly": "Maandelijks gefactureerd tot je opzegt.",
      "Payment_once": "Eenmalige betaling – niets terugkerends.",
      "Payment_mixed": "Dit mandje bevat zowel eenmalige als maandelijkse dekking.",
      "Payment_mixed_warning": "Je mandje bevat {oneOff} eenmalig(e) en {monthly} maandelijks(e) plan(nen). Die kunnen niet in één transactie worden betaald – verwijder een van beide soorten om verder te gaan en reken de andere apart af.",
      "Promotion": "Actie",
      "Discount": "Korting",
      "You_save": "Je bespaart {amount}",
      "Save_more_percent": "Voeg nog {count} artikel(en) toe aan je mandje en bespaar {percent}%.",
      "Save_more_bundle": "Voeg nog {count} artikel(en) toe voor een bundel van {size} artikelen voor {price}.",
      "Covers_label": "Dekt",
      "Whats_covered": "Wat is gedekt",
      "Hide_covered": "Verberg wat is gedekt",
      "Exclusions": "Wat is niet gedekt",
      "Hide_exclusions": "Verberg wat niet is gedekt",
      "Terms_link": "Polisvoorwaarden",
      "Change_cover": "Dekking wijzigen",
      "Plan_ref": "Plan",
      "Confirm_remove": "Ja, verwijderen",
      "Cancel": "Behouden",
      "Removed_notice": "{name} is uit je mandje verwijderd.",
      "Add_cover_again": "Dekking opnieuw toevoegen",
      "Dismiss": "Sluiten",
      "Empty_basket_body": "Voeg een product toe om de beschikbare beschermingsplannen te zien en kom hier terug om af te rekenen.",
      "Basket_reference": "Referentie van je mandje",
      "Need_help": "Hulp nodig bij je bestelling?",
      "No_cover_body": "Deze apparaten zijn niet gedekt en tellen niet mee in je totaal. Je kunt er nu nog dekking voor toevoegen.",
      "No_basket_id": "We konden geen mandje vinden om te tonen. Open deze pagina vanuit je aanbod of voeg ?id=JOUW_MANDJE_ID toe aan het adres."
    },
    "tr": {
      ...
      "Step_device": "Cihazınız",
      "Step_cover": "Teminat seçin",
      "Step_basket": "Sepet",
      "Step_payment": "Güvenli ödeme",
      "Checkout_progress": "Ödeme adımları",
      "Order_summary": "Sipariş özeti",
      "Reassurance_title": "Bilmeniz gerekenler",
      "Secure_payment": "Ödeme Stripe tarafından güvenle işlenir; kart bilgilerinizi asla görmeyiz.",
      "Documents_emailed": "Ödemeniz onaylanır onaylanmaz her ürün için bir sözleşme düzenlenir ve bunu istediğiniz zaman Sözleşmelerim bölümünden görüntüleyebilirsiniz.",
      "Term_monthly": "Aylık teminat, iptal edene kadar",
      "Term_months": "{months} aylık teminat",
      "Monthly_equivalent": "ayda yaklaşık {amount}",
      "Per_month_suffix": "/ay",
      "Billing_monthly": "Aylık",
      "Billing_one_off": "Tek seferlik",
      "Payment_monthly": "İptal edene kadar aylık faturalandırılır.",
      "Payment_once": "Tek seferlik ödeme; yinelenen ücret yok.",
      "Payment_mixed": "Bu sepette hem tek seferlik hem aylık teminat var.",
      "Payment_mixed_warning": "Sepetinizde {oneOff} tek seferlik ve {monthly} aylık plan var. Bunlar tek işlemde ödenemez; devam etmek için bir türünü çıkarın, diğerini ayrıca ödeyin.",
      "Promotion": "Kampanya",
      "Discount": "İndirim",
      "You_save": "{amount} tasarruf ediyorsunuz",
      "Save_more_percent": "Sepetinize {count} ürün daha ekleyin ve %{percent} tasarruf edin.",
      "Save_more_bundle": "{size} ürünlük paketi {price} fiyatına almak için {count} ürün daha ekleyin.",
      "Covers_label": "Kapsam",
      "Whats_covered": "Neler kapsanıyor",
      "Hide_covered": "Kapsananları gizle",
      "Exclusions": "Neler kapsanmıyor",
      "Hide_exclusions": "Kapsanmayanları gizle",
      "Terms_link": "Poliçe şartları",
      "Change_cover": "Teminatı değiştir",
      "Plan_ref": "Plan",
      "Confirm_remove": "Evet, çıkar",
      "Cancel": "Kalsın",
      "Removed_notice": "{name} sepetinizden çıkarıldı.",
      "Add_cover_again": "Teminatı yeniden ekle",
      "Dismiss": "Kapat",
      "Empty_basket_body": "Uygun koruma planlarını görmek için bir ürün ekleyin, sonra ödeme için buraya dönün.",
      "Basket_reference": "Sepet referansı",
      "Need_help": "Siparişinizle ilgili yardım ister misiniz?",
      "No_cover_body": "Bu cihazlar teminat kapsamında değil ve toplamınıza dahil edilmez. Şimdi onlar için de teminat ekleyebilirsiniz.",
      "No_basket_id": "Gösterilecek bir sepet bulamadık. Bu sayfayı teklifinizden açın veya adrese ?id=SEPET_KIMLIGINIZ ekleyin."
    },
    "pt": {
      ...
      "Step_device": "O seu dispositivo",
      "Step_cover": "Escolher cobertura",
      "Step_basket": "Cesto",
      "Step_payment": "Pagamento seguro",
      "Checkout_progress": "Progresso da compra",
      "Order_summary": "Resumo da encomenda",
      "Reassurance_title": "Bom saber",
      "Secure_payment": "O pagamento é processado em segurança pela Stripe — nunca vemos os dados do seu cartão.",
      "Documents_emailed": "É emitido um contrato para cada artigo assim que o pagamento for confirmado e pode consultá-lo a qualquer momento em Os meus contratos.",
      "Term_monthly": "Cobertura mensal, até cancelar",
      "Term_months": "{months} meses de cobertura",
      "Monthly_equivalent": "cerca de {amount} por mês",
      "Per_month_suffix": "/mês",
      "Billing_monthly": "Mensal",
      "Billing_one_off": "Pagamento único",
      "Payment_monthly": "Faturado mensalmente até cancelar.",
      "Payment_once": "Pagamento único — sem cobranças recorrentes.",
      "Payment_mixed": "Este cesto mistura cobertura de pagamento único e mensal.",
      "Payment_mixed_warning": "O seu cesto tem {oneOff} plano(s) de pagamento único e {monthly} plano(s) mensal(ais). Não podem ser pagos numa única transação — remova um dos tipos para continuar e pague o outro em separado.",
      "Promotion": "Promoção",
      "Discount": "Desconto",
      "You_save": "Poupa {amount}",
      "Save_more_percent": "Adicione mais {count} artigo(s) ao cesto e poupe {percent}%.",
      "Save_more_bundle": "Adicione mais {count} artigo(s) para um pacote de {size} artigos por {price}.",
      "Covers_label": "Cobre",
      "Whats_covered": "O que está coberto",
      "Hide_covered": "Ocultar o que está coberto",
      "Exclusions": "O que não está coberto",
      "Hide_exclusions": "Ocultar o que não está coberto",
      "Terms_link": "Condições da apólice",
      "Change_cover": "Alterar cobertura",
      "Plan_ref": "Plano",
      "Confirm_remove": "Sim, remover",
      "Cancel": "Manter",
      "Removed_notice": "{name} foi removido do seu cesto.",
      "Add_cover_again": "Adicionar cobertura novamente",
      "Dismiss": "Fechar",
      "Empty_basket_body": "Adicione um produto para ver os planos de proteção disponíveis e volte aqui para finalizar a compra.",
      "Basket_reference": "Referência do cesto",
      "Need_help": "Precisa de ajuda com a sua encomenda?",
      "No_cover_body": "Estes dispositivos não estão cobertos e não fazem parte do seu total. Ainda pode adicionar cobertura para eles agora.",
      "No_basket_id": "Não encontrámos nenhum cesto para mostrar. Abra esta página a partir da sua oferta ou adicione ?id=O_SEU_ID_DE_CESTO ao endereço."
    }
  },
  "checkout-success": {
    "en": {
